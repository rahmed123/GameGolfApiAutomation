...
public class ApiAutomation 
{
	...
	/*@Test(priority = 9) // Unable to run due to query parameters issues
	public void TC0009_POSTSearchfollowers() 
	   {
			//Specify base URI
					...
					//Response Object 
					Response response = httpRequest.request(Method.POST, "user/search?default_operator=AND&with=you_follow");
	...
	public void TC0023_GETApproachMissLastRound() 
	   {
		           ...
		           test = extent.createTest("Test Case 23", "Insights - Approach miss Last round max distance = 100 ");
					...
					//Send Request and Get response
					String relativeURL =  "api/stats/approach_miss?v=2&user_id="+this.userId+"&rounds_offset=0&rounds_limit=1&max_distance=100";
					Response response = httpRequest.request(Method.GET, relativeURL);
	...
	public void TC0024_GETApproachMissLastRound() 
	   {
		            ...
		            //Extent Report             
		           test = extent.createTest("Test Case 24", "Insights - Approach miss Last round, min distance = 100 and max distance = 150 ");
					...
					String relativeURL =  "api/stats/approach_miss?v=2&user_id="+this.userId+"&rounds_offset=0&rounds_limit=1&max_distance=150&min_distance=100";
					Response response = httpRequest.request(Method.GET, relativeURL);
	...
	public void TC0025_GETApproachMissLastRound() 
	   {
		            ...
		            //Extent Report             
		           test = extent.createTest("Test Case 25", "Insights - Approach miss Last round, min distance = 100 and max distance = 150 ");
